...
from app.routers import users_router, organizations_router, files_router, transactions_router, company_documents_router, companies_router ,formats_router
...
app.include_router(company_documents_router.router, prefix="/api/v1")
app.include_router(companies_router.router, prefix="/api/v1")
app.include_router(formats_router.router, prefix="/api/v1")

if __name__ == "__main__":
    import uvicorn
    uvicorn.run(app, host="0.0.0.0", port=3003,log_level="debug")